    ...
    window.GN_I18N = {
        translations: {
            en: {
                ...
                tokens_help_text: 'You earn 1 token every 3 consecutive days of workout. You can rest a day protecting your streak by spending a token.',
                freeze_day: 'Rest today',
                freeze_day_confirm: 'Spend 1 Token to freeze today?',
            ...
            pt: {
                ...
                tokens_help_text: 'Você ganha 1 token a cada 3 dias consecutivos de treino. Você pode descansar um dia protegendo sua sequência ao gastar um token.',
                freeze_day: 'Descansar hoje',
                freeze_day_confirm: 'Gastar 1 Token para congelar o dia de hoje?',
