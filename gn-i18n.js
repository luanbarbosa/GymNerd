    ...
    window.GN_I18N = {
        translations: {
            en: {
                ...
                page_start_routine: 'Start Workout',
                menu_home: 'Home',
                routines: '🏋 Routines',
                ...
                sort_exercises: 'Sort exercises',
                select_exercise_alert: 'To sort exercises, first select at least 1 exercise',
                ...
                routine_changed_notice_title: 'Your routine(s) changed today!',
                routine_changed_notice_subtext: 'Do you want to update the routine(s) or just save it to history (default)?',
                routine_changed_notice_checkbox: 'Update routine(s) data',
            ...
            pt: {
                ...
                sort_exercises: 'Ordenar exercícios',
                select_exercise_alert: 'Para ordenar os exercícios, primeiro selecione pelo menos 1 exercício',
                ...
                routine_changed_notice_title: 'Sua(s) rotina(s) mudou hoje!',
                routine_changed_notice_subtext: 'Deseja atualizar o(s) treino(s) ou apenas salvar no histórico (padrão)?',
                routine_changed_notice_checkbox: 'Atualizar dados do(s) treino(s)',
